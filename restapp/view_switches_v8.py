from restapp import api_restplus
...
class SetOfSwitches_v8(Resource):
    ...
    def __init__(self):
        ...
        super(SetOfSwitches_v8, self).__init__()
...
api_restplus.add_resource(SetOfSwitches_v8, '/todo/api/v8.0/Switches', endpoint='Switches_v8')